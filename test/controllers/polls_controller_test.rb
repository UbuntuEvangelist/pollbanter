...
class PollsControllerTest < ActionController::TestCase
  ...
  test "should create poll" do
    assert_difference('Poll.count') do
      post :create, poll: { negative: @poll.negative, positive: @poll.positive, title: @poll.title }
    end
  ...
  test "should update poll" do
    patch :update, id: @poll, poll: { negative: @poll.negative, positive: @poll.positive, title: @poll.title }
    assert_redirected_to poll_path(assigns(:poll))
  end
